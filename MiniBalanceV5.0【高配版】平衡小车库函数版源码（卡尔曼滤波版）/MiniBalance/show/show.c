...
{   
    Vol=(float)Voltage/100;
		...
		DataScope_Get_Channel_Data( Moto1/100, 2 );         			  	//作用到电机的最终pwm/100
		DataScope_Get_Channel_Data( Moto2/100, 3 );                   //作用到电机的最终pwm/100
		DataScope_Get_Channel_Data( Encoder_Left, 4 );                //左编码器的脉冲计数
		DataScope_Get_Channel_Data( Encoder_Right, 5 );               //右编码器的脉冲计数
		DataScope_Get_Channel_Data( encoder_Integral/100, 6 );        //累计积分/100
